...
# Matcher
echo "-----------------------------------------------------  Start Matching  -----------------------------------------------------"
CUDA_VISIBLE_DEVICES=0 python3 matcher.py --task Structured/Amazon-Google --input_path input/candidates.jsonl --output_path $3 --lm roberta --max_len 128 --use_gpu --checkpoint_path checkpoints --fp16;
