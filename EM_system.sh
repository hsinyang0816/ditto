...
[ -f blocker_model.zip ] && echo "Model exists" || wget -O blocker_model.zip 'https://www.dropbox.com/s/79xil3arrq1vdn3/model.pt?dl=1'
...
# Blocker
echo "-----------------------------------------------------  Start Blocking  -----------------------------------------------------"
CUDA_VISIBLE_DEVICES=0 python3 blocking/blocker.py  --input_path blocking/input/  --left_fn table_A.txt  --right_fn table_B.txt  --output_fn ../../input/candidates.jsonl  --model_fn blocker_model.pth  --k 5
